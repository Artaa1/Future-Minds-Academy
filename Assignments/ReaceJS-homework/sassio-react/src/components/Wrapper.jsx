export default function Wrapper(props) {
   return (
      ...
      <div className="wrapper-full text-center">
         ...
         <h1 className="text-center">{props.headling}</h1><br />
         <div className="secure-section">
            <div className="row square all-shadow">
               ...
               <span className="col-5 m-1 text-left">
                  <h3 className="dark">{props.rtActivity}</h3><br />
                  <p>
            ...
            <div className="row  square all-shadow">
               ...
               <span className="col-5 m-1 text-left">
                  <h3 className="dark">{props.instantDeploy}</h3><br />
                  <p>
                     {props.sDescription}
                  </p>
               </span>
            ...
            <div className="row square all-shadow">
               ...
               <span className="col-5 m-1 text-left">
                  <h3 className="dark">{props.easyIntegrations}</h3><br />
                  <p>
                     {props.thDescription}
                  </p>
               </span>
            ...
            <div className="row square all-shadow">
               ...
               <span className="col-5 m-1 text-left">
                  <h3 className="dark">{props.perfectUI}</h3><br />
                  <p>
                     {props.fDescription}
                  </p>
               </span>
